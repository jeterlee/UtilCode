...
import com.jeterlee.utilcode.Res;
...
public final class ScreenUtils {
    ...
    public static int getScreenWidth() {
        WindowManager windowManager = ServiceUtils.getWindowManager();
    ...
    public static boolean isScreenLock() {
        KeyguardManager km = ServiceUtils.getKeyguardManager();
    ...
    public static void setSleepDuration(int duration) {
        Settings.System.putInt(Ctx.getContentResolver(), Settings.System.SCREEN_OFF_TIMEOUT, duration);
    }
    ...
    public static Bitmap snapShotWithoutStatusBar(Activity activity) {
        ...
        Bitmap bp = Bitmap.createBitmap(bmp, 0, statusBarHeight,
                bmp.getWidth(), bmp.getHeight() - statusBarHeight);
        view.destroyDrawingCache();
