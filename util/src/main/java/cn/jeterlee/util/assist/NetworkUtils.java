package cn.jeterlee.util.assist;
...
public class NetworkUtils {
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        return ServiceUtils.getConnectivityManager().getActiveNetworkInfo();
    }
    ...
    public static boolean isConnectedOrConnecting() {
        NetworkInfo[] nets = ServiceUtils.getConnectivityManager().getAllNetworkInfo();
        if (nets != null) {
    ...
    public static boolean isAvailableByPing() {
        try {
            ...
            if (result.errorMsg != null) {
                Logger.d("isAvailableByPing errorMsg : %s", result.errorMsg);
            }
            if (result.successMsg != null) {
                Logger.d("isAvailableByPing successMsg : %s", result.successMsg);
            }
            return ret;
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public static boolean getDataEnabled() {
        try {
            TelephonyManager tm = ServiceUtils.getTelephonyManager();
    ...
    public static boolean getWifiEnabled() {
        return ServiceUtils.getWifiManager().isWifiEnabled();
    }
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm = ServiceUtils.getConnectivityManager();
    ...
    public static WifiInfo getWifiConnectionInfo() {
        return ServiceUtils.getWifiManager().getConnectionInfo();
    }
