...
public class ToastUtils {
    ...
    private static void showToast(CharSequence text, int duration) {
        ...
        if (sToast == null) {
            sToast = Toast.makeText(Ctx.getApplicationContext(), text, duration);
        } else {
            sToast.setText(text);
    ...
    private static void showToast(int resId, int duration) {
        showToast(Ctx.getResources().getText(resId).toString(), duration);
    }
    ...
    private static void showToast(int resId, int duration, Object... args) {
        showToast(String.format(Ctx.getResources().getString(resId), args), duration);
    }
