package cn.jeterlee.util.cipher;
...
import cn.jeterlee.util.common.CloseUtils;
...
public final class EncryptUtils {
     ...
     * @return Base64编码后的字符串
     */
    public static String base64HexStringEncode(byte[] input) {
        return bytes2HexString(base64Encode(input));
    }
     ...
     * @return Base64解码后的字符串
     */
    public static String base64HexStringDecode(byte[] input) {
        return bytes2HexString(base64Decode(input));
    }
