...
public class APILevel {
    ...
    /**
     * @return true when the caller API version is at least Oreo MR1 27
     */
    ...
    /**
     * @return true when the caller API version is less than Nougat 24
     */
    public static boolean deprecatedAtNougat() {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.N;
    }

    /**
     * @return true when the caller API version is less than Nougat MR1 25
     */
    public static boolean deprecatedAtNougatMR1() {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.N_MR1;
    }

    /**
     * @return true when the caller API version is less than Oreo 26
     */
    public static boolean deprecatedAtOreo() {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.O;
    }

    /**
     * @return true when the caller API version is less than Oreo MR1 27
     */
    public static boolean deprecatedAtOreoMR1() {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.O_MR1;
    }
}
